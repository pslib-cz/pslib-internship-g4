        ...
        case "LIST":
            return (
                <Suspense fallback={<Loader />}>
                    <BranchesDisplay id={id} switchModeAction={x => setMode(x)} setEditIdAction={(x:number)=>{setLocationId(x)}}/>
                    <Box mt="10">
        ...
        case "EDIT":
            return (
                <>
                    ...
                    <BranchesEdit closeAction={() => setMode("LIST")} companyId={id} locationId={locationId}/>
                </>
            );
    }
}
