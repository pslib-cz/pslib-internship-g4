...
import { Title, LoadingOverlay, Text, Alert, Breadcrumbs, Anchor, 
    Container, TextInput, Button, Group, Textarea, Checkbox, 
    NativeSelect, NumberInput } from "@mantine/core"
...
const Page = ({ params }: { params: { id: string } }) => {
    ...
    const editor = useEditor({
        extensions: [
          StarterKit,
          Placeholder.configure({ placeholder: '<p>Jedna z největších megakorporací světa.</p>' }),
          TipLink,
        ],
        ...
        <>
            ...
            <Container>
                ...
                <Group justify="flex-start" mt="md">
                    ...
                    <Button component={Link} href="/dashboard/companies" variant="default">Storno</Button>
                </Group>
                </form>
            </Container>
        </>
