    ...
    >
      ...
      <AppShell.Navbar p={0}>
        ...
        <NavLink
          ...
          active={pathname.includes("/dashboard/diaries")}
        />
        <NavLink
          component={Link}
          ...
          active={pathname.includes("/dashboard/companies")}
        />
        <NavLink
          component={Link}
          ...
          active={pathname.includes("/dashboard/inspections")}
        />
        <NavLink
          component={Link}
          ...
          active={pathname.includes("/dashboard/locations")}
        />
        <NavLink
          component={Link}
          href="/dashboard/internships"
          label="Praxe"
          leftSection={<IconClockDollar />}
          active={pathname.includes("/dashboard/internships")}
        />
        <NavLink
          component={Link}
          href="/dashboard/sets"
          ...
          active={pathname.includes("/dashboard/sets")}
        />
        <NavLink
          component={Link}
